...
static void * rtDataAddrMap [ ] = { & rtB . aj3l5kclho [ 0 ] , & rtB .
nxvv4e2bp1 [ 0 ] , } ; static int32_T * rtVarDimsAddrMap [ ] = { ( NULL ) } ;
#endif
...
const uint_T rtDimensionArray [ ] = { 2 , 1 , 162 , 1 } ; static const real_T
...
, { 3461545584U , 2443424883U , 703012654U , 897972491U } , ( NULL ) , 0 , (
boolean_T ) 0 , rt_LoggedStateIdxList } ; const
rtwCAPI_ModelMappingStaticInfo *
OP_AMP_DESIGN_INVERTING_CONFIGURATION_GetCAPIStaticMap ( void ) { return &
mmiStatic ; }
#ifndef HOST_CAPI_BUILD
void OP_AMP_DESIGN_INVERTING_CONFIGURATION_InitializeDataMapInfo ( void ) {
